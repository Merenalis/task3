...
/*
let text2='var_text_hello'
        func(text2)
        function func(text) {
            let result, result_tmp = '';
            result_tmp = text.replace(new RegExp('([^_])([^_]+)', 'g'), (match, match2, match3, match4, match5, match6) => {
        /!*        alert(match)
                alert(match2)
                alert(match3)
                alert(match4)
                ...
                return  match2.toUpperCase() + match3
            });

            result = result_tmp.replace(new RegExp('[_]', 'g'), '')
           // alert( result[0].toLowerCase()+result.slice(1));
